...
hl.window_rule({ match = { class = "com.lite_xl.LiteXL" }, workspace = 7 })
hl.window_rule({ match = { class = "cudatext" }, workspace = 7 })
hl.window_rule({ match = { class = "spicy" }, workspace = 7 })
hl.window_rule({ match = { title = ".*Notepad Next.*" }, workspace = 7 })
hl.window_rule({ match = { class = "Notesnook" }, workspace = 7 })
